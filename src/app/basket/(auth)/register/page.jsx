...
import fetchRegister from "@/app/getLib/fetchRegister";
...
const[error, setError]= useState(false)
  ...
  return (
    <div className="w-full h-screen ml-auto mr-auto bg-transparent rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
          ...
          <p className="text-sm font-light text-gray-500 dark:text-gray-400">
            ...
            Already have an account? <Link href="/basket/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</Link>
          </p>
        </form>
